...
def test_control_card_bot_against_three_random_legal_bots_monte_carlo() -> None:
    ...
    print("")
    print("Monte Carlo: ControlCardBot vs 3 RandomLegalBot")
    print(f"Games: {GAME_COUNT}")
    print(f"ControlCardBot wins: {lowest_valid_wins} ({lowest_valid_wins / GAME_COUNT:.1%})")
